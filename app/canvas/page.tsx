    ...
    <div className="h-full overflow-y-auto">
      <div className="mx-auto max-w-[1080px] px-6 py-8">
        ...
        <div className="mt-4 rounded-xl border border-[#262626] bg-[#141414] px-4 py-3 text-[12px] leading-relaxed text-[#8a8a8a]">
          ...
          （真的把畫面錄成影片檔，可下載），錄製時抽出的幾張畫面能直接送去影片生成當多重參考圖——影片生成 API
          本身沒有「用一段影片當運鏡參考」這種功能，所以送過去的是抽出的畫面加自動產生的運鏡文字提示，不是整段影片。
          目前仍只有單一自由視角相機、純色背景；多相機同時運作、360° 全景背景還在後續開發中。圖層合成、字型、錄音配音、
          Agent 呼叫其他節點當工具這些 ByteDance Canvas 才有的功能，這裡還沒有對應的 API 可以接，所以先不做假的。
        </div>

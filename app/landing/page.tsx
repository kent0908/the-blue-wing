...
// Independent entry/marketing page (2026-09-07: split out of "/" per user
// request — this is NOT 首頁 anymore. "/" is the real app home (the
...
export default async function LandingPage(){
  ...
  <header className={styles.header}>
    <Link href="/landing" className={styles.brand}><Image src="/wing-mark.png" width={38} height={38} alt=""/>The Blue Wing</Link>

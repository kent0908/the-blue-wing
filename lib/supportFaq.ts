...
export const FAQ_CATEGORIES: FaqCategory[] = [
  {
    ...
    entries: [
      ...
      {
        question: "有開放尺度（N- 開頭）版本的模型嗎？",
        answer:
          "部分模型有開放尺度版本（模型名稱會帶 N- 前綴，例如 N-Seedream-5.0-pro），用來解鎖更開放尺度的內容——例如成年陪聊角色到達特定好感度階段後的專屬場景與換裝功能，就會自動切換使用。功能與一般版本相同，差別只在內容尺度。",
      },
      {
  ...
  },
  {
    ...
    entries: [
      {
        question: "官方角色和我的創作有什麼不同？",
        answer:
          "「官方角色」是平台自己的 IP——私立蒼翼高中二年A班被拉進太古修真世界的十位同學，人設、外觀和待機影片都由官方提供，點一位就能開始聊，好感度、記憶和對話都是你自己的進度，設定不能修改。其中未滿 18 歲的角色是全年齡設定：只有友誼與夥伴關係（信賴階段），沒有解鎖場景與換裝衣櫃。「我的創作」是你用資產庫圖片建立的角色（18 歲以上），之後會開放分享給其他人與分潤。",
      },
      {
        question: "怎麼建立一個陪聊角色？",
        answer:
